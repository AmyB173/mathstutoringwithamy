...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Online A Level Maths tutoring for Year 12 and Year 13. 1:1, small group, and the 12-Week Recovery Course.",
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-lg-6">
          ...
          <a href="./recovery.php" class="btn-cta-pro">Find out more about the Recovery Course</a>
        </div>
