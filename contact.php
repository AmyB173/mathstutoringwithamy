          ...
          <div class="warm-card">
            <form id="contact-form">
              <div class="row g-4">
                ...
                <div class="col-12">
                  <label class="form-label fw-bold">Maths help for:</label>
                  <div class="row g-2 mt-2">
                    <div class="col-md-3">
                      <div class="form-check p-3 border rounded" style="border-radius: 12px !important;">
                        <input class="form-check-input" type="radio" name="mathsLevel" id="ks3" value="KS3" required />
                        <label class="form-check-label fw-bold" for="ks3">KS3</label>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-check p-3 border rounded" style="border-radius: 12px !important;">
                        <input class="form-check-input" type="radio" name="mathsLevel" id="gcse" value="GCSE" />
                        <label class="form-check-label fw-bold" for="gcse">GCSE</label>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-check p-3 border rounded" style="border-radius: 12px !important;">
                        <input class="form-check-input" type="radio" name="mathsLevel" id="aLevel" value="A Level" />
                        <label class="form-check-label fw-bold" for="aLevel">A Level</label>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-check p-3 border rounded" style="border-radius: 12px !important;">
                        <input class="form-check-input" type="radio" name="mathsLevel" id="adult" value="Adult" />
                        <label class="form-check-label fw-bold" for="adult">Adult</label>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-12">
                  <label for="examBoard" class="form-label fw-bold">Exam Board (if relevant)</label>
                  <input type="text" class="form-control" id="examBoard" name="examBoard" 
                         style="border-radius: 12px; padding: 12px; border: 2px solid #e9ecef;" />
                </div>
                <div class="col-12">
                  <label for="message" class="form-label fw-bold">Message</label>
                  <textarea class="form-control" id="message" name="message" rows="5" required 
                            style="border-radius: 12px; padding: 12px; border: 2px solid #e9ecef;"></textarea>
                </div>
            ...
            <div id="success-message" class="alert alert-success mt-4" style="display: none; border-radius: 12px;">
              <strong>✅ Success!</strong> Your message has been sent successfully! I'll get back to you soon.
            </div>
            <div id="error-message" class="alert alert-danger mt-4" style="display: none; border-radius: 12px;">
