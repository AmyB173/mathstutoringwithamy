<nav class="navbar navbar-expand-lg fixed-top">
  <div class="container">
    ...
    <a href="contact.php" class="btn btn-primary d-lg-none">Message Me</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto me-4">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="./study-club.php">*NEW* A Level Maths Study Club</a></li>
            <li><a class="dropdown-item" href="./recovery.php">12 Week Intensive A Level Recovery Programme</a></li>
          </ul>
        </li>
      ...
      <a href="contact.php" class="btn btn-primary d-none d-lg-block">Message Me</a>
    </div>
  </div>
</nav>