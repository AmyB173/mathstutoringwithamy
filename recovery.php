...
<body>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 hero-content">
          ...
          <div class="hero-testimonial-snippet">
            "She completely changed the game for Fred. He's grown in confidence as Amy guided him through the content."
          </div>
  ...
  <section class="section" style="background: var(--warm-cream);">
    <div class="container">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-lg-8">
          <h2 class="display-5 fw-bold mb-4">Does this sound familiar?</h2>
          <p class="lead text-muted">These are the struggles I hear most often when parents first get in touch.</p>
        </div>
      </div>
      ...
      <div class="row g-4">
        <div class="col-md-6">
          <div class="d-flex align-items-start">
            ...
            <div>
              <h5 class="fw-bold">Declining grades despite real ability</h5>
              <p class="text-muted mb-0">They achieved Grade 6+ at GCSE but are now facing disappointing results and growing anxiety about university options.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="d-flex align-items-start">
            ...
            <div>
              <h5 class="fw-bold">Confidence has taken a hit</h5>
              <p class="text-muted mb-0">The negative self-talk has started. They're avoiding asking questions, procrastinating, and beginning to believe they're just not cut out for this.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="section testimonials-full">
    <div class="container">
      <div class="text-center mb-5">
        <h2 class="mb-3">What families are saying</h2>
        <p class="lead">Real results from parents and students.</p>
      </div>
      ...
      <div class="row align-items-center g-5">
        <div class="col-lg-6 order-lg-1">
          ...
          <div class="warm-card" style="border-color: #d1d5db;">
            ...
            <div class="row g-2">
              <div class="col-6">
                <div class="d-flex align-items-center gap-2 p-2" style="background: white; border-radius: 8px;">
                  <span>🎓</span><small><strong>12 years teaching</strong></small>
                </div>
              </div>
              <div class="col-6">
                <div class="d-flex align-items-center gap-2 p-2" style="background: white; border-radius: 8px;">
                  <span>📘</span><small><strong>PGCE with Distinction</strong></small>
                </div>
              </div>
              <div class="col-6">
                <div class="d-flex align-items-center gap-2 p-2" style="background: white; border-radius: 8px;">
                  <span>✅</span><small><strong>Edexcel A Level specialist</strong></small>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="section" style="background: white;">
    <div class="container">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-lg-8">
          <h2 class="display-5 fw-bold mb-4">What's included in the 12-week programme</h2>
        </div>
      </div>
          ...
          <div class="accordion" id="faqAccordion">
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq1" style="border-radius: 12px;">
            ...
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" style="border-radius: 12px;">
            ...
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" style="border-radius: 12px;">
                  What if it's not working for my child?
                </button>
              </h2>
              <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  I offer a happiness guarantee because I only want students who find the programme helpful. In the unlikely scenario that you want to cancel, you will be refunded any unused weeks of the programme, no questions asked. But here's the thing: if it's not working, we'll know early because of the twice-weekly check-ins, and we can adjust the approach before you'd even consider cancelling.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" style="border-radius: 12px;">
                  My child doesn't have time for another commitment
                </button>
              </h2>
              <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  They'll need to commit a minimum of 3 hours per week: 60 minutes for the live session and around 2 hours for video review and homework. But think about it this way: 3 focused hours per week for 12 weeks, or continue struggling for the next 18 months? The time investment now saves massive stress later.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq5" style="border-radius: 12px;">
                  Is this online? What tech do we need?
                </button>
              </h2>
              <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Yes, everything is 100% online, delivered through a secure, interactive whiteboard platform. You'll need: a laptop or iPad, a webcam, and a way to write on screen (I recommend a graphics tablet or an iPad with a pen).
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item mb-3" style="border: none; border-radius: 12px;">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq6" style="border-radius: 12px;">
                  How do we sign up?
                </button>
              </h2>
              <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Start by booking a free consultation. We'll talk through your child's situation and see if the programme is a good fit. If we're both happy to go ahead, you'll secure their place with payment.
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- ================================================ 10. CONTACT / WHATSAPP -->
  <section class="section section-purple text-center" id="message-recovery">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
  ...
  <section class="section" style="background: var(--warm-cream);" id="book-call">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="text-center mb-5">
            <h2 class="fw-bold">Prefer to talk? Book a video call below</h2>
            <p class="lead">This 20-minute call is for students and parents who are ready to turn things around in A Level Maths.</p>
          </div>
