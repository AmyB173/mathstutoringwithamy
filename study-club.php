...
<head>
    ...
    <meta property="og:description" content="A Level Maths Study Club by Maths Tutoring With Amy: weekly masterclasses, mindset sessions, and Q&A support for Year 13 Edexcel students. Currently closed.">
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="closed-notice">
                        <p class="fw-bold mb-1" style="color: var(--warm-purple);">The Study Club is currently closed.</p>
                        <p class="mb-2">It may reopen in the future. Still need help with your A Level? <a href="./a-level.php">Tutoring might be an option.</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-10">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            ...
                            <p class="hero-subtitle mb-4">Weekly live masterclasses, personalised Q&amp;A support, and a community of students all working towards their goals.</p>
    ...
    <section class="section fade-in" style="background: white;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 text-center">
                    ...
                    <p>Your chance to win a <strong>FREE</strong> 1:1 private tutoring session every month</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- A Level Tutoring -->
    <section class="section fade-in" style="background: rgba(201, 178, 248, 0.08);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="mb-3">Still Need Help With Your A Level?</h2>
                    <p class="lead mb-4">The Study Club is currently closed, but 1:1 tutoring is available. <a href="./a-level.php">Tutoring might be an option.</a></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer style="background: var(--warm-dark); color: white; padding: 2rem 0; text-align: center;">
        <div class="container">
            <p class="mb-0">&copy; 2025 Maths Tutoring With Amy. All rights reserved.</p>
        </div>
    </footer>
