            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <img src="./assets/images/amy-white-top.jpg" alt="Maths Tutor Amy" class="img-fluid hero-image" style="border-radius: 16px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08);">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6 text-center">
                   <iframe src="https://drive.google.com/file/d/1pEnxjSJ2F4wwOm_SGybHtknlTQ9grYVH/preview" width="100%" height="auto" style="aspect-ratio: 16 / 9; border: none;" allow="autoplay"></iframe>
                </div>
                <div class="col-lg-6">
                    ...
                    <ul class="fa-ul" style="font-size: 1.1rem; list-style-position: outside;">
                        ...
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-check-circle" style="color: var(--success-green);"></i></span>
                            You feel <strong>stuck at a grade you're not happy with</strong> and can't seem to break through to the next level (e.g. from a B to an A/A*).
                        </li>
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-check-circle" style="color: var(--success-green);"></i></span>
                            You're not finding your school lessons helpful enough and <strong>know you need something more</strong> than just the textbook.
                        </li>
                        <li class="mb-3">
                            <span class="fa-li"><i class="fas fa-check-circle" style="color: var(--success-green);"></i></span>
    ...
    <section class="section fade-in bg-accent-light">
        <div class="container">
            ...
            <div class="section-title mt-5 pt-4">
                <h3 class="fw-bold" style="color: #FF007F;">PLUS... YOU'LL ALSO GET:</h3>
            </div>
    ...
    <script>
        ...
        document.querySelectorAll('.faq-question').forEach(item => {
            item.addEventListener('click', event => {
                ...
                item.querySelector('.arrow').textContent = faqAnswer.classList.contains('show') ? '▲' : '▼';
            });
        });
    </script>
